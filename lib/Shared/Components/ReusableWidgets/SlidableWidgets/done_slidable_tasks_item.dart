...
class DoneSlidableTasksItem extends StatelessWidget {
  const DoneSlidableTasksItem({
    Key? key,
    required this.slidableKey,
    this.tasks,
    this.timeColor = Colors.black26,
    this.onPressedOnDuplicate,
    this.onPressedOnUndone,
    this.onPressedOnArchive,
  ...
  final Function(BuildContext)? onPressedOnDuplicate, onPressedOnUndone, onPressedOnArchive, onPressedOnDelete;
